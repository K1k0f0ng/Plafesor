...
async function preguntar(req, res) {
  ...
  try {
    ...
    const respuesta = await anthropic.messages.create({
      model: CLAUDE_MODEL,
      max_tokens: 550,
      system: `Eres el Tutor IA de Playfesor, asistente educativo de ${nombre}, estudiante de grado ${grado}° ${colegio ? `del colegio ${colegio}` : ''}. Sus materias son: ${materiasLista}.
