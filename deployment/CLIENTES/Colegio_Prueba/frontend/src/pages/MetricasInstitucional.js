    ...
    <div style={es.pagina}>
      ...
      <div style={es.contenido}>
        ...
        <div style={es.encabezado}>
          ...
          <h2 style={{ ...es.titulo, display: 'flex', alignItems: 'center', gap: 8 }}><IconBarChart size={20} style={{ color: 'var(--color-primario)' }} />Centro de Métricas — {datos?.colegio || ''}</h2>
        </div>
        ...
        {cargando ? (
          ...
          <>
            ...
            <div style={es.statsGrid}>
              ...
              <div style={es.statCard}>
                <IconClipboard size={28} style={{ color: 'var(--color-primario)' }} />
              ...
              <div style={es.statCard}>
                <IconCalendar size={28} style={{ color: 'var(--color-primario)' }} />
              ...
              <div style={es.statCard}>
                <IconBookOpen size={28} style={{ color: 'var(--color-primario)' }} />
            ...
            {tendencia.length > 1 && (
              <div style={es.seccionCard}>
                <h3 style={{ ...es.seccionTitulo, display: 'flex', alignItems: 'center', gap: 6 }}><IconTrendUp size={16} style={{ color: 'var(--color-primario)' }} />Tendencia semanal</h3>
            ...
            <div style={es.dosColumnas}>
              ...
              {/* Materias */}
              <div style={es.seccionCard}>
                <h3 style={{ ...es.seccionTitulo, display: 'flex', alignItems: 'center', gap: 6 }}><IconBookOpen size={16} style={{ color: 'var(--color-primario)' }} />Materias — de mayor a menor riesgo</h3>
                {materias.map((m, i) => {
              ...
              {/* Docentes */}
              <div style={es.seccionCard}>
                <h3 style={{ ...es.seccionTitulo, display: 'flex', alignItems: 'center', gap: 6 }}><IconUser size={16} style={{ color: 'var(--color-primario)' }} />Docentes — por impacto académico</h3>
                {docentes.map((d, i) => {
                  const col = colorPromedio(d.promedio);
                  const barPct = ((d.promedio || 0) / 5) * 100;
                  return (
                    <div key={d.docente_id} style={es.rankFila}>
                      <span style={{ ...es.rankPos, fontWeight: 700, color: 'var(--color-primario)', fontSize: 13 }}>{i + 1}.</span>
                      <div style={es.rankInfo}>
            ...
            {gruposUnicos.length > 0 && materiasUnicas.length > 0 && (
              <div style={es.seccionCard}>
                <h3 style={{ ...es.seccionTitulo, display: 'flex', alignItems: 'center', gap: 6 }}><IconMap size={16} style={{ color: 'var(--color-primario)' }} />Mapa de calor — Grupos × Materias</h3>
...
const es = {
  ...
  filtroBtnActivo: { background: 'linear-gradient(135deg, var(--color-primario), var(--color-secundario))', borderColor: 'var(--color-primario)', color: '#fff' },
