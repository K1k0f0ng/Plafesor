    ...
    <div style={es.pagina}>
      ...
      <div style={es.contenido}>
        ...
        <div style={es.dobleCol}>
          ...
          {/* Por materia */}
          <div style={{ flex: 1.4 }}>
            <h3 style={es.seccion}><IconBookOpen size={15} style={{ marginRight: 6, verticalAlign: 'middle', color: 'var(--color-primario)' }} />Rendimiento por materia</h3>
            {porMateria.length === 0 ? (
            ...
            {porPeriodo.length > 0 && (
              <>
                <h3 style={es.seccion}><IconBarChart size={15} style={{ marginRight: 6, verticalAlign: 'middle', color: 'var(--color-primario)' }} />Promedio por período</h3>
          ...
          <div style={{ flex: 1, minWidth: 260 }}>
            ...
            {tendencia.length > 1 && (
              <>
                <h3 style={es.seccion}><IconTrendUp size={15} style={{ marginRight: 6, verticalAlign: 'middle', color: 'var(--color-primario)' }} />Tendencia semanal</h3>
                <div style={es.card}>
                  {tendencia.map((t, i) => {
...
const es = {
  ...
  btnVolver: { background: 'none', border: 'none', color: 'var(--color-primario)', cursor: 'pointer', fontSize: 13, fontWeight: 700, padding: 0, fontFamily: 'inherit', marginBottom: 6, display: 'flex', alignItems: 'center' },
  ...
  kpiCard:   { background: '#fff', borderRadius: 14, padding: '16px 20px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)', flex: 1, minWidth: 120, borderTop: '4px solid var(--color-primario)' },
