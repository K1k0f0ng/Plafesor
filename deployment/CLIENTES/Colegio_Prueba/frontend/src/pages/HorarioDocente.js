...
const DIA_COLOR = ['', 'var(--color-primario)', 'var(--color-secundario)', '#f093fb', '#4facfe', '#43e97b'];
      ...
      <div style={es.contenido}>
        ...
        <div style={es.cabecera}>
          ...
          <div style={es.cabeceraInfo}>
            <IconCalendar size={22} style={{ color: 'var(--color-primario)' }} />
...
const es = {
  ...
  franjaMateria: { fontSize: 12, color: 'var(--color-primario)', fontWeight: 600 },
  btnEliminar: {
