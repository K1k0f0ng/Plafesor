  ...
  return (
    <div style={es.boletin}>
      ...
      <div style={es.encabezado}>
        ...
        <div style={es.periodoChip}>Período {b.periodo}</div>
      </div>
      ...
      {/* Pie */}
      <div style={es.pie}>
        Documento generado por {b.colegio.nombre} · {formatFecha()}
      </div>
    </div>
  );
}
          ...
          <div style={{ maxWidth: '760px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px', flexWrap: 'wrap' }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <p style={{ ...es.subtitulo, margin: 0 }}>Período {periodo} — {estudiantes.length} estudiante(s)</p>
              </div>
              <button
            ...
            <div style={{ display: 'flex', gap: '10px', marginBottom: '20px', alignItems: 'center', flexWrap: 'wrap' }}>
              ...
              <button
                ...
                onClick={() => descargarPDF(
                  ...
                  `Boletín_${boletin.estudiante.nombre}_P${boletin.periodo}`
                )}
              >
            ...
            <div style={{ display: 'flex', gap: '10px', marginBottom: '20px', alignItems: 'center', flexWrap: 'wrap' }}>
              ...
              <button
                ...
                onClick={() => descargarPDF(
                  ...
                  `Boletines_${grupoSel?.nombre}_P${periodo}`
                )}
              >
                <IconDownload size={15} />
