      ...
      <div style={es.contenido}>
        ...
        <div style={es.header}>
          <div>
            ...
            <h2 style={es.titulo}><IconSchool size={20} style={{ marginRight: 8, verticalAlign: 'middle', color: 'var(--color-primario)' }} />Gemelo Digital del Colegio</h2>
...
const es = {
  ...
  btnRefresh:{ background: '#fff', border: '2px solid #e0e0e0', borderRadius: 10, padding: '8px 16px', fontSize: 13, fontWeight: 700, cursor: 'pointer', color: 'var(--color-primario)', fontFamily: 'inherit' },
  ...
  gradoHeader: { fontSize: 13, fontWeight: 700, color: 'var(--color-primario)', marginBottom: 8, textTransform: 'uppercase', letterSpacing: '0.5px' },
  ...
  recNumero: { background: 'linear-gradient(135deg, var(--color-primario), var(--color-secundario))', color: '#fff', borderRadius: '50%', width: 24, height: 24, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 700, flexShrink: 0 },
};
