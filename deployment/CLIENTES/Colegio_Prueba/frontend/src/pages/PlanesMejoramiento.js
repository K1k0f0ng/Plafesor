      ...
      <div style={es.contenido}>
        ...
        <div style={es.header}>
          <div>
            ...
            <h2 style={es.titulo}><IconClipboard size={20} style={{ marginRight: 8, verticalAlign: 'middle', color: 'var(--color-primario)' }} />Planes de Mejoramiento</h2>
...
const es = {
  ...
  btnVolver: { background: 'none', border: 'none', color: 'var(--color-primario)', cursor: 'pointer', fontSize: 14, fontWeight: 600, padding: 0, fontFamily: 'inherit', marginBottom: 6 },
  ...
  filtroBtonActivo: { background: 'linear-gradient(135deg, var(--color-primario), var(--color-secundario))', borderColor: 'var(--color-primario)', color: '#fff' },
  ...
  badgePeriodo: { background: '#f0f0ff', color: 'var(--color-primario)', borderRadius: 20, padding: '2px 10px', fontSize: 12, fontWeight: 700 },
  ...
  diagLabel: { fontWeight: 700, color: 'var(--color-primario)' },
  btnExpandir: { background: 'none', border: 'none', color: 'var(--color-primario)', cursor: 'pointer', fontSize: 13, fontWeight: 600, padding: '4px 0', fontFamily: 'inherit', textAlign: 'left' },
  planTexto: { background: '#f8f9fa', borderRadius: 10, padding: 16, marginTop: 10, borderLeft: '4px solid var(--color-primario)' },
