...
// instalación. Si la variable no está definida, se usa FRONTEND_URL como respaldo (nunca un
// dominio fijo — cada instalación tiene el suyo propio).
...
app.get('/', (req, res) => {
  res.json({ mensaje: 'API activa', version: '1.0.0', estado: 'OK' });
});
...
app.listen(PORT, () => {
  console.log(`Servidor de ${process.env.INSTITUCION_NOMBRE || 'la institución'} corriendo en puerto ${PORT}`);
