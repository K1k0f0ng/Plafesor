...
async function generarBriefingColegio(colegioId) {
  ...
  try {
    const resp = await anthropic.messages.create({
      model: CLAUDE_MODEL,
      max_tokens: 220,
      system: `Eres el asistente ejecutivo de ${colegio.nombre} para su rector/a. Escribes resúmenes matutinos breves, en lenguaje ejecutivo y cercano, nunca técnico ni con jerga de datos. Vas directo a lo importante y siempre terminas recomendando una sola cosa concreta para revisar primero.`,
      messages: [{
        role: 'user',
