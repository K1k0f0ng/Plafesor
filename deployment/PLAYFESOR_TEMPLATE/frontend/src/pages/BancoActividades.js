...
const es = {
  ...
  tipoBadge:  { background: '#f0f0ff', color: 'var(--color-primario)', borderRadius: 20, padding: '3px 10px', fontSize: 11, fontWeight: 700 },
  ...
  btnCopiar:  { background: 'linear-gradient(135deg, var(--color-primario), var(--color-secundario))', color: '#fff', border: 'none', borderRadius: 10, padding: '9px 16px', fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', marginTop: 4 },
  ...
  btnConfirmar: { background: 'linear-gradient(135deg, var(--color-primario), var(--color-secundario))', color: '#fff', border: 'none', borderRadius: 9, padding: '10px 22px', fontSize: 14, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', flex: 1 },
