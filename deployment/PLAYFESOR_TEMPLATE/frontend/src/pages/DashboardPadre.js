  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div style={es.historialStats}>
        ...
        <div style={es.hStatBox}>
          <span style={{ fontSize: '20px', fontWeight: '900', color: 'var(--color-primario)' }}>{historial.length}</span>
        ...
        return (
          <div key={c.id} style={{ ...es.anotacionCard, borderLeft: `4px solid ${cfg.color}` }}>
            ...
            {(c.fecha_cita || c.lugar) && (
              <p style={{ ...es.anotacionMeta, color: 'var(--color-primario)', fontWeight: '700', marginBottom: '2px' }}>
              ...
              <div style={es.selectorWrap}>
                ...
                <div style={es.selectorBtns}>
                  {hijos.map((h, i) => (
                    ...
                    >
                      <span style={{ ...es.selectorAvatar, background: hijoIdx === i ? 'var(--color-primario)' : '#e0e0e0', color: hijoIdx === i ? '#fff' : '#888' }}>
                        {h.nombre.charAt(0).toUpperCase()}
                      </span>
                      <span style={{ fontWeight: hijoIdx === i ? '700' : '500', color: hijoIdx === i ? 'var(--color-primario)' : '#555' }}>
                        {h.nombre.split(' ')[0]}
                      </span>
                ...
                {tab === 'resumen' && (
                  <>
                    ...
                    <div style={es.statsRow}>
                      ...
                      <div style={es.statBox}>
                        <span style={{ fontSize: '24px', fontWeight: '800', color: 'var(--color-primario)' }}>
...
const es = {
  ...
  selectorBtnActivo: { borderColor: 'var(--color-primario)', background: '#f0f0ff' },
  ...
  hijoAvatar: { width: '48px', height: '48px', borderRadius: '50%', flexShrink: 0, background: 'linear-gradient(135deg, var(--color-primario), var(--color-secundario))', color: '#fff', fontSize: '22px', fontWeight: '800', display: 'flex', alignItems: 'center', justifyContent: 'center' },
