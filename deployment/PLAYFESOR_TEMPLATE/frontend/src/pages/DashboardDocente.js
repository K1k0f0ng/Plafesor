      ...
      <div style={es.contenido}>
              ...
              <div style={es.hoyCard}>
                <div style={es.hoyEncabezado}>
                  <span style={es.hoyFecha}>
                    <IconCalendar size={15} style={{ marginRight: 6, verticalAlign: 'middle', color: 'var(--color-primario)' }} />
                    {hoyStr}
                  </span>
        ...
        <div style={es.accionesGrid}>
          <button onClick={() => navigate('/crear-actividad')} style={es.btnAccion}>
            <IconEdit size={26} style={{ color: 'var(--color-primario)' }} />
          ...
          <button onClick={() => navigate('/mis-actividades')} style={es.btnAccion}>
            <IconClipboard size={26} style={{ color: 'var(--color-primario)' }} />
          ...
          <button onClick={() => navigate('/pasar-lista')} style={es.btnAccion}>
            <IconCheckSquare size={26} style={{ color: 'var(--color-primario)' }} />
          ...
          <>
            <div style={es.materiasGrid}>
              {asignaciones.map(asig => (
                ...
                >
                  <IconBookOpen size={22} style={{ color: 'var(--color-primario)' }} />
...
const es = {
  ...
  btnAccion: {
    ...
    borderTop: '4px solid var(--color-primario)', fontFamily: 'inherit',
  },
  ...
  materiaCardActiva: { borderColor: 'var(--color-primario)', background: '#f0f0ff' },
  materiaNombre: { fontWeight: '700', fontSize: '15px', color: '#333' },
  materiaGrupoInfo: { fontSize: '12px', color: 'var(--color-primario)', fontWeight: '600' },
  materiaCodigo: { fontSize: '12px', color: '#888' },
  materiaVer: { fontSize: '12px', color: 'var(--color-primario)', marginTop: '4px' },
  ...
  hoyBtnLista: { background: 'linear-gradient(135deg, var(--color-primario), var(--color-secundario))', color: '#fff', border: 'none', borderRadius: '8px', padding: '6px 14px', fontSize: '12px', fontWeight: '700', cursor: 'pointer', fontFamily: 'inherit', whiteSpace: 'nowrap' },
