  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={es.statsRow}>
        ...
        <div style={es.statBox}>
          <span style={{ fontSize: '22px', fontWeight: '900', color: 'var(--color-primario)' }}>{completadas.length}</span>
            ...
            return (
              <div key={act.id} style={es.barraCol}>
                ...
                <div style={es.barraFondo}>
                  <div style={{ ...es.barraRelleno, height: `${pct}%`, background: nivel?.color || 'var(--color-primario)' }} />
                </div>
...
const es = {
  ...
  btnVolver: { background: 'none', border: 'none', color: 'var(--color-primario)', cursor: 'pointer', fontSize: '14px', fontWeight: '600', marginBottom: '24px', padding: 0, fontFamily: 'inherit' },
  ...
  tabBadge: { background: 'var(--color-primario)', color: '#fff', borderRadius: '20px', padding: '1px 7px', fontSize: '11px' },
  ...
  badge: { background: '#f0f0ff', color: 'var(--color-primario)', borderRadius: '20px', padding: '2px 8px', fontSize: '12px', fontWeight: '600' },
  ...
  btnIniciar: { background: 'linear-gradient(135deg, var(--color-primario), var(--color-secundario))', color: '#fff', borderRadius: '8px', padding: '8px 16px', fontSize: '13px', fontWeight: '700' },
  ...
  historialNum: { width: '28px', height: '28px', borderRadius: '50%', background: '#f0f0ff', color: 'var(--color-primario)', fontSize: '12px', fontWeight: '800', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
