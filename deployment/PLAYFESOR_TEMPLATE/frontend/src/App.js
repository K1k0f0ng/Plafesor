...
function PantallaCarga() {
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#f0f2f5', gap: '16px' }}>
      <div style={{ width: '40px', height: '40px', border: '4px solid #e0e0e0', borderTop: '4px solid var(--color-primario)', borderRadius: '50%', animation: 'spin 0.8s linear infinite' }} />
...
function AppRoutes() {
  return (
    <Routes>
      {/* Esta plantilla sirve a una sola institución — la raíz va directo al login,
          sin la página de marketing multi-colegio del proyecto core. */}
