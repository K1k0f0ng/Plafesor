  ...
  return (
    <aside style={es.sidebar}>
      ...
      <div style={es.logoArea}>
        <img src="/logo-icon.png" alt={NOMBRE_INSTITUCION} style={es.logoIcono} />
        <span style={es.logoText}>{NOMBRE_INSTITUCION}</span>
      </div>
...
const es = {
  ...
  activoDot: {
    ...
    background: 'var(--color-primario)', flexShrink: 0,
  },
  userArea: {
