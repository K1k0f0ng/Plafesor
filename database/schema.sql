...
CREATE TABLE IF NOT EXISTS usuarios (
  ...
  rol ENUM('admin','docente','estudiante','director','padre','orientador') NOT NULL,
  colegio_id INT,
...
-- ============================================================
-- TABLA: usuario_colegios — otros colegios a los que un admin puede
-- cambiarse. usuarios.colegio_id sigue siendo el colegio activo.
-- ============================================================
...
-- ============================================================
-- MÓDULO BIENESTAR Y ORIENTACIÓN (ver docs/BIENESTAR_MAPA_FUNCIONAL.md)
-- Las columnas marcadas "cifrado" guardan texto cifrado por el backend.
-- ============================================================
