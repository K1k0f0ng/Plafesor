...
import {
  ...
  IconChevronRight, IconClock, IconGrid, IconBell, IconShield, IconMap, IconList, IconRefresh, IconLink,
} from './Icons';
...
const MENU = {
  admin: [
    ...
    { tipo: 'link', Icono: IconGrid,       label: 'Grados Académicos', ruta: '/grados-academicos', modulo: 'institucion_academica' },
    { tipo: 'link', Icono: IconBookOpen,   label: 'Grupos',       ruta: '/grupos', modulo: 'institucion_academica' },
    { tipo: 'link', Icono: IconCalendar,   label: 'Semana Académica', ruta: '/semana-academica', modulo: 'institucion_academica' },
    { tipo: 'link', Icono: IconMap,        label: 'Salones de Clase', ruta: '/salones', modulo: 'institucion_academica' },
    ...
    { tipo: 'link', Icono: IconShield,     label: 'Usuarios del Sistema', ruta: '/personal' },
    { tipo: 'seccion', label: 'Asignaturas' },
    { tipo: 'link', Icono: IconList,       label: 'Definición de Áreas', ruta: '/areas-academicas', modulo: 'asignaturas' },
    { tipo: 'link', Icono: IconCheckSquare,label: 'Asignaturas por Grado', ruta: '/asignaturas-por-grado', modulo: 'asignaturas' },
