...
const MENU = {
  admin: [
    ...
    { tipo: 'link', Icono: IconCalendar,   label: 'Semana Académica', ruta: '/semana-academica' },
    { tipo: 'link', Icono: IconMap,        label: 'Salones de Clase', ruta: '/salones' },
    ...
    { tipo: 'link', Icono: IconList,       label: 'Definición de Áreas', ruta: '/areas-academicas' },
    { tipo: 'link', Icono: IconCheckSquare,label: 'Asignaturas por Grado', ruta: '/asignaturas-por-grado' },
    { tipo: 'link', Icono: IconFileText,   label: 'Materias',     ruta: '/materias' },
    { tipo: 'link', Icono: IconRefresh,    label: 'Reasignación de Carga', ruta: '/reasignacion-carga' },
    { tipo: 'link', Icono: IconLink,       label: 'Traslado de Clases', ruta: '/traslado-clases' },
